...
function rChartsImpl(all){
  ...
  const moDs=[
    ...
    {type:'line',label:'전체 접수',data:cumR,borderColor:cvar('--ch-recv','#3E71D2'),backgroundColor:cvar('--ch-bg','#fff'),pointBackgroundColor:cvar('--ch-bg','#fff'),pointBorderColor:cvar('--ch-recv','#3E71D2'),pointBorderWidth:2,tension:.4,pointRadius:4,pointHoverRadius:8,pointHoverBorderWidth:3,pointHoverBackgroundColor:cvar('--ch-recv','#3E71D2'),pointHoverBorderColor:'#fff',hoverBorderWidth:3.5,borderWidth:2.5,fill:false,yAxisID:'y1',order:1,animations:_lineAnim,datalabels:{display:ctx=>window.innerWidth>768&&(ctx.dataIndex===0||ctx.dataIndex===ctx.dataset.data.length-1),opacity:_op,anchor:'center',align:ctx=>ctx.dataIndex===0?'right':'left',offset:8,clip:false,color:dlBlue(),font:{size:11,weight:700},textStrokeColor:dlStroke(),textStrokeWidth:4,textShadowColor:'rgba(0,0,0,.2)',textShadowBlur:3,formatter:v=>v.toLocaleString()}},
    {type:'line',label:'처리 완료',data:cumRes,borderColor:cvar('--ch-done','#F0B144'),backgroundColor:cvar('--ch-bg','#fff'),pointBackgroundColor:cvar('--ch-bg','#fff'),pointBorderColor:cvar('--ch-done','#F0B144'),pointBorderWidth:2,tension:.4,pointRadius:4,pointHoverRadius:8,pointHoverBorderWidth:3,pointHoverBackgroundColor:cvar('--ch-done','#F0B144'),pointHoverBorderColor:'#fff',hoverBorderWidth:3.5,borderWidth:2.5,fill:false,yAxisID:'y1',order:0,animations:_lineAnim,datalabels:{display:ctx=>window.innerWidth>768&&(ctx.dataIndex===0||ctx.dataIndex===ctx.dataset.data.length-1),opacity:_op,anchor:'center',align:ctx=>ctx.dataIndex===0?'right':'left',offset:8,clip:false,color:dlAmber(),font:{size:11,weight:700},textStrokeColor:dlStroke(),textStrokeWidth:4,textShadowColor:'rgba(0,0,0,.2)',textShadowBlur:3,formatter:v=>v.toLocaleString()}}
  ];
  ...
  const lgMo=document.getElementById('c-mo-lg');if(lgMo)lgMo.innerHTML=[
    {label:'60일 이상',type:'bar',color:cvar('--ch-d60','#DA6A60')},
    {label:'30~59일',type:'bar',color:cvar('--ch-d30','#E89C9A')},
    {label:'30일 미만',type:'bar',color:cvar('--ch-d0','#B3C7DD')},
    {label:'전체 접수',type:'line',color:cvar('--ch-recv','#3E71D2')},
    {label:'처리 완료',type:'line',color:cvar('--ch-done','#F0B144')}
...
function rSite(sid){
  ...
  const _legend=`<div class="ltrmom-lg"><div class="li"><span class="mk" style="background:#DA6A60"></span>60일 이상</div><div class="li"><span class="mk" style="background:#E89C9A"></span>30~59일</div><div class="li"><span class="mk" style="background:${cvar('--ch-d0','#B3C7DD')}"></span>30일 미만</div></div>`;
...
function buildSiteTrend(sid,st){
  ...
  const moDs=[
    ...
    {type:'line',label:'전체 접수',data:cumR,borderColor:cvar('--ch-recv','#3E71D2'),backgroundColor:cvar('--ch-bg','#fff'),pointBackgroundColor:cvar('--ch-bg','#fff'),pointBorderColor:cvar('--ch-recv','#3E71D2'),pointBorderWidth:2,tension:.4,pointRadius:4,pointHoverRadius:8,borderWidth:2.5,fill:false,yAxisID:'y1',order:1,animations:_lineAnim,datalabels:{display:ctx=>window.innerWidth>768&&(ctx.dataIndex===0||ctx.dataIndex===ctx.dataset.data.length-1),opacity:_op,anchor:'center',align:ctx=>ctx.dataIndex===0?'right':'left',offset:8,clip:false,color:dlBlue(),font:{size:11,weight:700},textStrokeColor:dlStroke(),textStrokeWidth:4,formatter:v=>v.toLocaleString()}},
    {type:'line',label:'처리 완료',data:cumRes,borderColor:cvar('--ch-done','#F0B144'),backgroundColor:cvar('--ch-bg','#fff'),pointBackgroundColor:cvar('--ch-bg','#fff'),pointBorderColor:cvar('--ch-done','#F0B144'),pointBorderWidth:2,tension:.4,pointRadius:4,pointHoverRadius:8,borderWidth:2.5,fill:false,yAxisID:'y1',order:0,animations:_lineAnim,datalabels:{display:ctx=>window.innerWidth>768&&(ctx.dataIndex===0||ctx.dataIndex===ctx.dataset.data.length-1),opacity:_op,anchor:'center',align:ctx=>ctx.dataIndex===0?'right':'left',offset:8,clip:false,color:dlAmber(),font:{size:11,weight:700},textStrokeColor:dlStroke(),textStrokeWidth:4,formatter:v=>v.toLocaleString()}}
  ];
  const _atSize=(typeof window!=='undefined'&&window.innerWidth<=768)?10:13;const _tkSize=(typeof window!=='undefined'&&window.innerWidth<=768)?9:12;
