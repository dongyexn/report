...
function rSite(sid){
  ...
  const _legend=`<div class="ltrmom-lg"><div class="li"><span class="mk" style="background:${cvar('--ch-d60','#DA6A60')}"></span>60일 이상</div><div class="li"><span class="mk" style="background:${cvar('--ch-d30','#E89C9A')}"></span>30~59일</div><div class="li"><span class="mk" style="background:${cvar('--ch-d0','#B3C7DD')}"></span>30일 미만</div></div>`;
